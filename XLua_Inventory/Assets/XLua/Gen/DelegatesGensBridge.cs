...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp11(int p0, out int p1, out bool p2, out string p3, out int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp12(int p0, ref int p1, ref bool p2, ref string p3, ref int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(int p0, object[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CallFunction.customDele2))
			{
			    return new CallFunction.customDele2(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(CallFunction.customDele3))
			{
			    return new CallFunction.customDele3(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(CallFunction.customDele4))
			{
			    return new CallFunction.customDele4(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(CallFunction.customDele5))
			{
			    return new CallFunction.customDele5(__Gen_Delegate_Imp13);
			}
